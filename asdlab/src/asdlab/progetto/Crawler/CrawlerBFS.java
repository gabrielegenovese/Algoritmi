...
/**
 * La classe <code>CrawlerBFS</code> implementa un crawler basato su visita BFS. 
 * Le pagine Web esaminate durante la visita BFS vengono acquisite e memorizzate
 * su disco per poi essere successivamente indicizzate. La classe  <code>CrawlerBFS</code>
 * &egrave; realizzata derivando la classe {@link VisitaBFS}
 ...
 * specializza il metodo {@link VisitaBFS#visita(Nodo u)} di {@link VisitaBFS},
...
public class CrawlerBFS extends VisitaBFS implements Crawler {
	...
	/**
	 * Visita il nodo di input <code>u</code> secondo la logica BFS ed
	 ...
	 * di {@link VisitaBFS} per visitare il nodo <code>u</code> secondo
	 * la logica BFS. Successivamente, si acquisisce tramite l'oggetto
